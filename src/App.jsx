    ...
    <div className="app">
      ...
      <main>
        <section className="hero">
          <h1 className="hero-title">Welcome to Ecommerce Multivendor</h1>
          <div className="hero-buttons">
            <button className="btn btn-primary">Browse Store</button>
            <button className="btn btn-secondary">Join Us The Vendor</button>
          </div>
        </section>
      </main>
    </div>
